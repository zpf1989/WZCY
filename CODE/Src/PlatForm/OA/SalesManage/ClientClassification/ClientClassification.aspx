<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClientClassification.aspx.cs" Inherits="OA_SalesManage_ClientClassification_ClientClassification" %>
...
<body>
    <div class="easyui-layout" fit="true">
        <div region="north" collapsible="true" title="查询条件" height="80px" style="padding: 10px;">
            <form id="searchForm" action="#" style="text-align: left">
                <label>客户名称：</label><input name="ClientName" id="txtClientName" class="easyui-textbox" />
                <label>客户等级：</label><input name="LevelName" id="txtLevelName" class="easyui-textbox" />
    ...
    <script src="ClientClassification.js"></script>
    <script>
        $(cc.init);
    </script>
</body>
