<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AskPriceApproval.aspx.cs" Inherits="OA_SalesManage_AskPrice_AskPriceApproval" %>
...
<body>
    ...
    <script src="AskPriceApproval.js"></script>
    <script>
        $(askprice.init());
    </script>
</body>
