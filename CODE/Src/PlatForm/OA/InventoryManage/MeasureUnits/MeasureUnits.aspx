<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MeasureUnits.aspx.cs" Inherits="OA_InventoryManage_MeasureUnits_MeasureUnits" %>
...
<body>
    <div class="easyui-layout" fit="true">
        <div region="north" collapsible="true" title="查询条件" height="80px" style="padding: 10px;">
            <form id="searchForm" action="#" style="text-align: left">
                <label>编号：</label><input name="UnitCode" id="UnitCode" class="easyui-textbox" />
                <label>名称：</label><input name="UnitName" id="UnitName" class="easyui-textbox" />
    ...
    <script src="MeasureUnits.js"></script>
    <script>
        $(units.init);
    </script>
</body>
