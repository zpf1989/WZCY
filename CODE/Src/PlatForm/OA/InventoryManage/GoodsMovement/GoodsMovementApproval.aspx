<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GoodsMovementApproval.aspx.cs" Inherits="OA_InventoryManage_GoodsMovement_GoodsMovementApproval" %>
...
<body>
    ...
    <script src="GoodsMovementApproval.js"></script>
    <script>
        $(gm.init());
    </script>
</body>
