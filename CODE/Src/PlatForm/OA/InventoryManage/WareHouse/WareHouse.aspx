<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WareHouse.aspx.cs" Inherits="OA_InventoryManage_WareHouse_WareHouse" %>
    ...
    <div class="easyui-layout" fit="true">
        <div region="north" collapsible="true" title="查询条件" height="80px" style="padding: 10px;">
            <form id="searchForm" action="#" style="text-align: left">
                <label>仓库编号：</label><input name="WareHouseCode" id="WareHouseCode" class="easyui-textbox" />
                <label>仓库名称：</label><input name="WareHouseName" id="WareHouseName" class="easyui-textbox" />
