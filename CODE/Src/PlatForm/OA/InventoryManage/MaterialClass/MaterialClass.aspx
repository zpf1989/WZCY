<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MaterialClass.aspx.cs" Inherits="OA_InventoryManage_MaterialClass_MaterialClasses" %>
...
<body>
    <div class="easyui-layout" fit="true">
        <div region="north" collapsible="true" title="查询条件" height="80px" style="padding: 10px;">
            <form id="searchForm" action="#" style="text-align: left">
                <label>编号：</label><input name="MaterialClassCode" id="MaterialClassCode" class="easyui-textbox" />
                <label>名称：</label><input name="MaterialClassName" id="MaterialClassName" class="easyui-textbox" />
    ...
    <script src="MaterialClass.js"></script>
    <script>
        $(classes.init);
    </script>
</body>
